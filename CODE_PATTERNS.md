...
> - **Global**: [.agents/knowledge/code-patterns.md](file:///c:/Users/hp15s/Desktop/Boiler-Plates/react-supabase-boilerplate/.agents/knowledge/code-patterns.md)
...
## 💎 The "Gold Standard"
All development in this repository must adhere to the patterns defined in the internal knowledge base. These rules ensure that the codebase remains clean, predictable, and scalable.
...
For practical implementation examples and detailed rules, see the [Full Code Pattern Guide](file:///c:/Users/hp15s/Desktop/Boiler-Plates/react-supabase-boilerplate/.agents/knowledge/code-patterns.md).
