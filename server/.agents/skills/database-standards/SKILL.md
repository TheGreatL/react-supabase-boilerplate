...
## 🎯 Purpose
This skill governs how agents interact with the Prisma schema, enforcing strict naming conventions, mandatory audit fields, table mapping, indexing, and relationship integrity.
...
- **Table Mapping**: ALWAYS use `@@map("snake_case_plural")` to map to a standard database table name (e.g., `@@map("user_profiles")`).
