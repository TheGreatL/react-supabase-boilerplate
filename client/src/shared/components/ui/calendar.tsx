  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative rounded-md border border-input shadow-xs has-focus:border-ring has-focus:ring-[0.1875rem] has-focus:ring-ring/50',
      ...
      components={{
        ...
        WeekNumber: ({ children, ...calendarProps }) => {
          return (
            <td {...calendarProps}>
