...
- **Database (Prisma) Strategy**: Never hit a production or shared development database.
  ...
  - *Option B (Preferred for Integration/API Tests)*: Use an isolated test database (e.g., via Docker) and ensure each test is wrapped in a transaction or cleaned up after.
